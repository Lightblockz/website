...
function subscribe($data , $method , $url)
{
...
$response = subscribe($data , "POST" , "https://dashboard.lightblocks.biz/index.php/api/signal/subscription/create");
